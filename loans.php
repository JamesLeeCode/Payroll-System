...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
    <div class="card card-danger" style=" margin-left: 10px; margin-right: 10px">
      ...
      <div id="collapseTwo" class="" >
        <div class="card-body">
          <form  method="POST" action="phpScripts/addLoan.php">
              ...
              ?>
                ...
                <div class="form-group">
                 <label for="exampleInputEmail1">Enter Loan/Credit Amount</label>
                   <input type="number" required class="form-control" id="loanAmout" name="loanAmout" required placeholder="Enter Loan/Credit Amount">
                   </div>
