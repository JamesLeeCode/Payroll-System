<?php
   ...
   $conn = OpenCon();
    ...
    $sql ="SELECT employee_info.firstname, employee_info.lastname, employee_info.employeeNumber,monthlyrecords.loans, monthlyrecords.bonus,
     monthlyrecords.overTime, monthlyrecords.saturdaysOverTime, monthlyrecords.holidayOverTime,designations.basicSalary,
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input style="width:100px" type="numbers"  class="form-control" id="loanAmout" name="loanAmout" value="0">
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                      <input type="numbers"  class="form-control" id="loanAmout" name="loanAmout" value="0">
                    </div>
                  </td>
                </tr>
                <?php
