...
<head>
  ...
  <title>PayRoll | Edit Employee Info</title>
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td> <button type="button" onclick="window.location.href='editEmployeePage.php?id=<?php echo $row['employeeNumber']; ?>&title=<?php echo $row['jobTitle']; ?>'"  class="btn btn-block btn-danger btn-sm">Edit information</button></td>
            </tr>
            <?php
                 };
             ?>
