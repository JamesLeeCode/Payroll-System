...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="bonus.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bonus</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
    <div class="card card-success" style=" margin-left: 10px; margin-right: 10px">
      ...
      <div id="collapseThree" >
        <div class="card-body">
           <form  method="POST" action="phpScripts/addBonus.php">
          <div class="form-group">
            <label for="exampleSelectRounded0">Select Employee</label>
            <select id="employeeNumber" name="employeeNumber" required class="form-control select2bs4" style="width: 100%;">
                <option value="all" > Add Bonus To All Employees</option>
              <?php
          ...
          <div class="form-group">
           ...
           <input type="number" required class="form-control" id="bonusAmout" name="bonusAmout" required placeholder="Enter Bonus Amount in Rands">
         </div>
